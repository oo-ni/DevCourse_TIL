...
public class Melon {
    ...
    public void saveMelonList(List<MelonVO> arr) {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("D:/DevCourse_TIL/JavaDemo/src/w1.crawling/melon_240718.txt"))) {
            oos.writeObject(arr);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void main(String[] args) {
        ...
        melon.loadMelonList("D:/DevCourse_TIL/JavaDemo/src/w1.crawling/melon_240718.txt");
    }
