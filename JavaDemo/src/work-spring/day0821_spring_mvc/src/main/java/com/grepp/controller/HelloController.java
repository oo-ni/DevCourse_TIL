...
//    }
    ...
    // 파라미터가 여러 개인데 한꺼번에 받아서 처리하고 싶을 때 객체 하나에 다 담아주기도 함 (DTO)
    // 이때, 객체의 멤버변수 이름과 클라이언트 파라미터 이름을 일치는 시켜야 함.
//    @GetMapping("/bye")
