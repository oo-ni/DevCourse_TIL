...
<div id="divComment">
    ...
    작성자 : <input type="text" id="ttt"><br>
    댓글 : <input type="text" id="ccc"><br>
...
<script>
    async function getComments() {
        ...
        for (let i = 0; i < result.length; i++) {
            ...
            tdContent.appendChild(document.createTextNode(result[i].content));
    ...
    document.getElementById('btnSend').onclick = async function () {
        ...
        alert('작성자 : '+ttt+" // 내용 : "+ccc+ "라는 내용을 백엔드 서버에게 전송해주세요.")
        let url = '<%=request.getContextPath()%>/comment/write?writer='+ttt+'&content='+ccc+'&bno='+<%=bbb.getNo()%>;
