package com.grepp.day0904.controller;

import com.grepp.day0904.model.dto.UserDTO;
import com.grepp.day0904.model.entity.UserEntity;
import com.grepp.day0904.model.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<?> signin(@RequestBody UserDTO userDTO){
        ...
        if(userEntity != null){ // login success
            String token = myJwtTokenProvider.createMyToken(userEntity, 1000*60*5);
